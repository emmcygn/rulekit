...
describe('syncToTarget (reload / scroll restoration path)', () => {
  it('snaps a mid-page start onto the target instead of flying there from 0', () => {
    ...
    // Half the page lands inside 05-clash, 0.5926 of the way through it:
    // chapters 00-04 are 486 of the 1100vh, and 05 is 108 more.
    expect(s.p).toBeCloseTo(0.5926, 3);
